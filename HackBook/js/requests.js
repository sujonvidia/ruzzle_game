...
function sendRequestSingleSelect(fID) {

	var friendID = friendIDs[fID];
  ...
  FB.ui({
    ...
    //Use the first friend returned
    to: friendID,
    message: "test message: "+emptySlot
  }, function(response) {
    console.log('sendRequestSingle UI response: ', JSON.stringify(response));
  });
}