...
var cordova = {
    ...
    callbackFromNative: function(callbackId, success, status, message, keepCallback) {
       console.log("callbackFromNative "+callbackId+ " " + success+ " " + status+ " " + message+ " " + keepCallback)
       console.log("callbackFromNative "+cordova.callbacks[callbackId])
...
var contacts = {
    ...
    create:function(properties) {
       ...
       choose:function(successCB, errorCB, s, m){
       exec(successCB, errorCB, "Contacts", "chooseContact", [{subject:s, message:m, fields:["name", "phoneNumbers", "emails", "photos"]}]);
       },
};
