(function () {
  ...
  var noConflict = function (uri, options) {
	...
	//Changed from 0 to allow for socketio local load
    ...
    for (var i = 0, ii = dependencies.length; i < ii; i++) {
	  ...
	  //Load local socket IO, simple put <script src="/socket.io/socket.io.js"></script>, and this sould not be called
  ...
  window.pvpInitialize = noConflict;
}());